                    ...
                    if(isset($websitebox['websitebox'])){
                        ...
                        switch($websitebox['websitebox']){
                           ...
                           case 13:
                                ...
                                $website1['left'] = $websitebox['left'];
                                $website1['right'] = $websitebox['right'];
                                $website1['left_img'] = $websitebox['left_img'];
                                $website1['right_img'] = $websitebox['right_img'];
    ...
    public  function websitebox_toplevelpage(){
        ...
        switch ($book) {
            ...
            case 13:
                ...
                require plugin_dir_path( WEBSITEBOX_FILE ) . 'guanggao.php';
                break;
            default:
                // code...
                break;
