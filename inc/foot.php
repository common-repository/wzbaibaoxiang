...
class websitebox_foot{
    ...
    public  function websitebox_footpage(){
        ...
        //留言
            ...
            if(isset($websitebox_liuyan['auto']) && $websitebox_liuyan['auto']==1){
                echo '
            		...
            		<script>
            		jQuery(document).ready(function($){
            		    if ($(".websitebox_cebian4 h3").css("background-color") == "rgb(255, 255, 255)" || $(".websitebox_cebian4 h3").css("background-color") == "#FFF") {
            		        $(".websitebox_cebian4 h3").css("color", "#000");
            		        $(".websitebox_cebian4-2 a").css("color", "#000");
            		    }
        ...
        if (isset($websitebox_guanggao['left']) || isset($websitebox_guanggao['right'])) {
            if (!empty($websitebox_guanggao['left_img']) || !empty($websitebox_guanggao['right_img'])) {
                $str = '
                    <style>
                        .websitebox_left_eva,
                ...
                if ($websitebox_guanggao['left'] == 1) {
                    $str .='<div class="websitebox_left_eva">
                        <div class="websitebox_eva_list">';
                    foreach($websitebox_guanggao['left_img'] as $key=>$val){
                        $str .='
                            <div class="websitebox_eva_item">
                                <a href="'.$val[2].'"><img src="'.$val[1].'" alt=""></a>
                                <span class="websitebox_eva_close"></span>
                            </div>
                        ';
                    }
                    $str .= '</div></div>';
                ...
                if ($websitebox_guanggao['right'] == 1) {
                    $str .= '<div class="websitebox_right_eva">
                        <div class="websitebox_eva_list">
                    ';
                    foreach ($websitebox_guanggao['right_img']as $key=>$val) {
                        $str .= '
                            <div class="websitebox_eva_item">
                                <a href="'.$val[2].'"><img src="'.$val[1].'" alt=""></a>
                                <span class="websitebox_eva_close"></span>
            ...
            if(isset($websitebox_scroll['auto']) && $websitebox_scroll['auto']==1){
		        ...
		        jQuery(document).ready(function($){
		            function loading() {
    		            ...
    		            } else if($("header").attr("id") || $("header").hasClass("wp-block-template-part") || $("header").hasClass("header-b")) {
    		                return;
