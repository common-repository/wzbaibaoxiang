...
class websitebox_head{
    ...
    public function websitebox_enqueue(){
        ...
        //   wp_enqueue_script( 'message.js',plugin_dir_url( WEBSITEBOX_FILE ).'kbn/js/message.js', array('jquery'), '', false);
        //   wp_localize_script( 'message.js', 'php_vars', ['message_Path'=>plugin_dir_url( WEBSITEBOX_FILE ).'kbn/','home_Path'=>trim(get_option('siteurl'),'/').'/'] );
